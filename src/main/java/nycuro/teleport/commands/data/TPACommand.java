...
public class TPACommand extends CommandBaseTeleportation {
    ...
    public boolean execute(CommandSender sender, String label, String[] args) {
        ...
        API.getTeleportationAPI().requestTP((Player) sender, player, true);
        player.sendMessage(API.getMessageAPI().messagesObject.translateMessage("commands.tpa.invite", sender.getName()));
