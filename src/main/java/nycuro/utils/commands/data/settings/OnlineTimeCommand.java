...
public class OnlineTimeCommand extends CommandBaseUtils {
    ...
    public boolean execute(CommandSender commandSender, String s, String[] strings) {
        ...
        if (strings.length == 0) {
            ...
            long session = System.currentTimeMillis() - Loader.startTime.getLong(player.getServerId());
            ...
            long sessionCommand = System.currentTimeMillis() - Loader.startTime.getLong(playerCommand.getServerId());
