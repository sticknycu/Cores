        ...
        switch (profileProxy.getLanguage()) {
            case 0:
                STRING = "         Profile Info:\n\n" +
                        ...
                        (player.isOnline() ? ("§eOnline on this session: §6" + Loader.time(System.currentTimeMillis() - API.getMainAPI().played.getLong(player.getUniqueId()))) + "\n" : "") +
            ...
            case 1:
                STRING = "         Profile Info:\n\n" +
                        ...
                        (player.isOnline() ? ("§eOnline pe aceasta sesiune: §6" + Loader.time(System.currentTimeMillis() - API.getMainAPI().played.getLong(player.getUniqueId()))) + "\n" : "") +
