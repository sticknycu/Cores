 ...
 * API 1.0.0
 */
public class TurretMonkeyKit extends CommonKit {

    @Override
    public NameKit getKit() {
        return NameKit.TURRET_MONKEY;
    }
    ...
    public StatusKit getStatus(Player player) {
        ...
        if (kitsObject.isPremium5()) return StatusKit.UNLOCKED;
    ...
    public Item[] getOtherItems() {
        ...
        splashpotion_instantkill.setCustomName(symbol + getKit().getName() + empty + "Instant Kill Splash Potion");
        Item splashpotion_fireresistance = Item.get(Item.POTION, 12, 24);
        splashpotion_instantkill.setCustomName(symbol + getKit().getName() + empty + "Fire Resistance Potion");
        return new Item[] {
                steak,
                potion_speed2,
                splashpotion_poison2,
                splashpotion_instantkill,
                splashpotion_fireresistance
        };
    }
