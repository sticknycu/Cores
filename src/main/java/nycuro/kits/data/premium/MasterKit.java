 ...
 * API 1.0.0
 */
public class MasterKit extends CommonKit {

    @Override
    public NameKit getKit() {
        return NameKit.MASTER;
    }
    ...
    public StatusKit getStatus(Player player) {
        ...
        if (kitsObject.isPremium2()) return StatusKit.UNLOCKED;
    ...
    public Item[] getOtherItems() {
        ...
        Item potion_healing2 = Item.get(Item.POTION, 22, 10);
        potion_healing2.setCustomName(symbol + getKit().getName() + empty + "Instant Healing 2 Potion");
        Item potion_instantkill1 = Item.get(Item.POTION, 24, 10);
        potion_instantkill1.setCustomName(symbol + getKit().getName() + empty + "Instant Kill 1 Potion");
        return new Item[] {
                steak,
                potion_healing2,
                potion_instantkill1
